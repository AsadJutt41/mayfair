...
<div class="row">
    ...
    <div class="col-lg-10 col-md-10">
           <div class="card-header">
                <h3 class="card-title">Upload Zone Csv File</h3>
            </div>
            <div class=" card-body">
                <div class="row">
                    <div class="col-md-12">
                        <label style="min-width: 275px;">File upload(csv,xlsx) <i class="text-danger">*</i> <a href="{{url('/csv-template/zone.csv')}}" target="_blank">Download Sample CSV</a></label>

                        <form  method="POST" action="{{route('import.zone_save')}}" enctype="multipart/form-data">
                            @csrf
